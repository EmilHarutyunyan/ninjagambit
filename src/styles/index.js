const styles = {
  ...
  normalText: 'font-rajdhani font-medium text-[24px] text-siteWhite',
  footerText: 'font-rajdhani font-medium text-base text-white',
  infoText: 'font-rajdhani font-medium text-lg text-[#d73a3a] cursor-pointer',
  ...
  hocContentBox: 'flex flex-1 justify-between bgHome py-8 sm:px-12 px-8 flex-col ',
  hocLogo: 'flex flex-row object-contain cursor-pointer sm:w-[250px] md:w-[120px] w-64 m-auto sm:mr-2 sm:ml-0',
  hocBodyWrapper: 'flex-1 flex justify-center flex-col xl:mt-0 my-16 max-w-3xl\t m-auto',
  ...
  btn: 'px-4 py-2 rounded-lg bg-[#87182d] hover:bg-[#ffc107] transition-all ease-in duration-300 w-fit text-white font-rajdhani font-bold',

  // custom input component
  label: 'font-rajdhani font-semibold text-2xl text-white mb-3',
  input: 'bg-siteDimBlack text-white outline-none focus:outline-[#d73a3a] p-4 rounded-md sm:max-w-[50%] max-w-full',

  // gameload component
  gameLoadContainer: 'absolute inset-0 z-10 w-full h-screen gameload flex-col',
  gameLoadBtnBox: 'w-full flex justify-end px-8',
  gameLoadText: 'font-rajdhani text-siteWhite text-2xl mt-5 text-center font-medium',
  gameLoadPlayersBox: 'flex justify-evenly items-center mt-20 gameVs',
  gameLoadPlayerImg: 'md:w-36 w-24 md:h-36 h-24 object-cover rounded-full drop-shadow-lg',
  gameLoadPlayerText: 'mt-3 font-rajdhani text-white md:text-xl text-base',
  gameLoadVS: 'font-rajdhani font-extrabold text-[#d73a3a] text-7xl mx-16',
