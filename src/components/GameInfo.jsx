...
const GameInfo = () => {
  ...
  return (
    <>
      ...
      <div className={`${styles.gameInfoSidebar} ${toggleSidebar ? 'flex opacity-100 transition-opacity pointer-events-auto' : 'pointer-events-none opacity-0'} ${styles.glassEffect} ${styles.flexBetween} backdrop-blur-3xl`}>
