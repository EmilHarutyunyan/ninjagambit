    ...
    switch (st) {
        ...
        return (
          <>
            <p className={styles.modalText}>
              You don't have Web3 Wallet installed!
            </p>
            <CustomButton
      ...
      case 1:
        return (
          <>
            <p className={styles.modalText}>
              You haven't connected your account to Web3 Wallet!
            </p>
            <CustomButton
      ...
      case 2:
        return (
          <>
            <p className={styles.modalText}>
              You're on a different network. Switch to Mumbai Testnet.
            </p>
        ...
        return (
          <>
            ...
            <CustomButton
              ...
              handleClick={() => window.open('https://mumbaifaucet.com/', '_blank')}
            />
          </>
        );
